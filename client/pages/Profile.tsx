    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-6 mb-6">
          <div className="w-20 h-20 bg-gradient-to-br from-brand-purple to-brand-blue rounded-full flex items-center justify-center text-white text-xl font-semibold">
            RK
          </div>
          <div>
            <h2 className="text-xl font-semibold">Rose K</h2>
            <p className="text-medium-gray">Lawyer</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <Input value="Rose" readOnly className="mt-1" />
          </div>
          <div>
            <Label className="text-xs text-medium-gray">Last Name</Label>
            <Input value="K" readOnly className="mt-1" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input value="Female" readOnly className="mt-1" />
          </div>
          <div>
            <Label className="text-xs text-medium-gray">LSC#</Label>
            <Input value="000000" readOnly className="mt-1" />
          </div>
          <div>
            <Label className="text-xs text-medium-gray">Phone</Label>
            <Input value="(416) 555-0123" readOnly className="mt-1" />
          </div>
          <div className="md:col-span-2">
            <Label className="text-xs text-medium-gray">Email</Label>
            <Input value="rose.greenthumb@example.com" readOnly className="mt-1" />
          </div>
          <div className="md:col-span-3">
            <Label className="text-xs text-medium-gray">Address</Label>
            <Input value="1508 - 141 Lyon Court, Toronto, ON M5B 3H2" readOnly className="mt-1" />
          </div>
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <Input value="Lawyer" className="mt-1" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input placeholder="Enter years" className="mt-1" />
          </div>
          <div>
            <Label className="text-xs text-medium-gray">Marital Status</Label>
            <Input placeholder="Enter status" className="mt-1" />
          </div>
          <div>
            <Label className="text-xs text-medium-gray">Emergency Contact</Label>
            <Input placeholder="Enter contact" className="mt-1" />
          </div>
          <div>
