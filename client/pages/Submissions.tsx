      ...
      <div className="w-full">
        ...
        <form className="bg-white p-8 space-y-6">
          ...
          <div className="pb-6 border-b border-gray-200">
            <h3 className="text-xs font-semibold text-gray-900 mb-4 uppercase tracking-wide">Insured & Submission Overview</h3>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="dba" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  DBA
                </Label>
                <Input 
                  id="dba" 
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="submission-suffix" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  Submission Suffix
                </Label>
                <Input 
          ...
          <div className="pb-6 border-b border-gray-200">
            <h3 className="text-xs font-semibold text-gray-900 mb-4 uppercase tracking-wide">Product & Coverage Details</h3>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="sub-class" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  Sub Class
                </Label>
                <Input 
                  id="sub-class" 
          ...
          {/* Section 3: Dates */}
          <div className="pb-6 border-b border-gray-200">
            <h3 className="text-xs font-semibold text-gray-900 mb-4 uppercase tracking-wide">Dates</h3>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-center gap-3">
                <Label htmlFor="proposed-effective-date" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="received-date" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  Received Date
                </Label>
                <Input 
                  id="received-date" 
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="proposed-expiration-date" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="requested-by-date" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  Requested By Date
                </Label>
                <Input 
          ...
          <div className="pb-6 border-b border-gray-200">
            <h3 className="text-xs font-semibold text-gray-900 mb-4 uppercase tracking-wide">Underwriting & Broker Details</h3>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xs font-semibold text-gray-900 mb-4 uppercase tracking-wide">Additional Details & Financials</h3>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <Label htmlFor="new-renewal" className="text-sm font-medium text-gray-700 w-32 flex-shrink-0">
                  New/Renewal
                </Label>
                <Input 
                  id="new-renewal" 
