    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 lg:px-6 pl-16 lg:pl-6 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>•</span>
          <span>Lawyer</span>
          <Badge className="bg-brand-green text-white text-xs">Active</Badge>
        </div>
      </div>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="h-9 px-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-gradient-to-br from-brand-purple to-brand-blue rounded-full flex items-center justify-center text-white text-sm font-semibold">
                  A
                </div>
                <span className="hidden lg:block text-sm font-medium">Agent Smith</span>
                <ChevronDown size={14} />
              </div>
            </Button>
          </DropdownMenuTrigger>
