...
export function BasicDetailsSection({ name, role, status = "Active", memberSince = "2020" }: BasicDetailsProps) {
  return (
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <Badge className="bg-gray-100 text-gray-700 border-gray-200">{status}</Badge>
                </div>
